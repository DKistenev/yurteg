...
Plans:
- [ ] 01-01: Версионированные миграции схемы SQLite (schema_migrations table)
- [ ] 01-02: providers/ package — LLMProvider ABC, ZAI и OpenRouter провайдеры
- [ ] 01-03: services/ layer — pipeline_service, registry_service
- [ ] 01-04: Нормализация дат через dateutil после AI-экстракции
