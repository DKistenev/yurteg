...
- [x] **Phase 13: Design Polish + Calendar** — Цветовая система, типографика, календарь, анимации (completed 2026-03-22)
...
Plans:
- [x] 08-01-PLAN.md — Data layer (_fetch_rows, _fuzzy_filter), AG Grid table с status badges
- [x] 08-02-PLAN.md — Search bar, segmented filter, row click navigation, client switching
- [x] 08-03-PLAN.md — Hover-actions, version grouping, visual verification
...
- [x] 13-02-PLAN.md — Per-file palette migration: gray→slate, gray-900→indigo-600 across all pages and components
- [x] 13-03-PLAN.md — Calendar toggle + FullCalendar component in registry
- [x] 13-04-PLAN.md — Full-suite verification + visual checkpoint
